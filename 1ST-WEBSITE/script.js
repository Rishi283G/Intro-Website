...
document
  ...
  .addEventListener("submit", function (event) {
    ...
    responseDiv.textContent = `Thank you, ${name}! Your suggestion has been received.`;
    responseDiv.style.color = "green";

    // Animate the response message
    responseDiv.style.opacity = "0"; // Start hidden
    responseDiv.style.transform = "translateY(10px)"; // Start slightly below

    // Trigger a reflow to restart the animation
    void responseDiv.offsetWidth; // This line forces a reflow

    // Set the final styles for the animation
    responseDiv.style.opacity = "1"; // Fade in
    responseDiv.style.transform = "translateY(0)"; // Move to original position
    responseDiv.style.transition = "opacity 0.5s ease, transform 0.5s ease"; // Transition for the animation
